...
public class FieldNames {
	public static final String ATSM = "atsm";
	...
	private static List<String> fieldNamesList = Arrays.asList(ATSM, COMMIT, DATA, DATABASE,
	GTID, OLD, POSITION, QUERY, SERVER_ID, TABLE, THREAD_ID, TIMESTAMP, TRANSACTION_ID, TSM, TYPE, UUID);
